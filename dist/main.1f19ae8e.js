...
var $addCard = $('.addCard');
var $layer = $('.layer');
var $delete = $('.layer .delete');
var $confirm = $('.modifyContainer .confirm');
var $cancel = $('.modifyContainer .cancel');
var $siteInput = $('.modifyContainer #siteInput');
var isTouchDevice = 'ontouchstart' in document.documentElement;
var data = JSON.parse(localStorage.getItem('siteArr'));
var siteArr = data || [{
  logo: 'A',
...
var render = function render() {
  ...
  siteArr.forEach(function (el, i) {
    var $li = $("<li class=\"site\">\n            <a href=\"".concat(el.url, "\" class=\"link\">\n                <span class=\"logo\">").concat(el.logo, "</span>\n                <span class=\"url\">").concat(simpleUrl(el.url), "</span>\n            </a>\n            <div class=\"modify\">\n                <svg class=\"icon\" aria-hidden=\"true\">\n                    <use xlink:href=\"#icon-xiugai\"></use>\n                </svg>\n            </div>\n        </li>")).insertBefore($addCard);
    ...
    var enventFn = function enventFn(e) {
      if (e.target.nodeName === 'svg' || e.target.nodeName === 'use') {
        ...
        $confirm.on('click', function () {
          var url = $siteInput.val(); //这里使用attr()，获取不到实时的文本框值
...
var ampleUrl = function ampleUrl(url) {
  return url.match(/^http/) ? url : "https://".concat(url);
}; // 打开网页第一次渲染
...
},{}],"C:/Users/wzipone/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2673" + '/');
